...
class AI(Player):
    ...
    def get_strategy(self, board):
        ...
        eplist = []
        # print self.field2data(board.empty_list)
        ...
        for turn in xrange(9):
            ...
            for no, player in enumerate(players):
                ...
                if result is not None:
                    ...
                    end_flag = 1
                elif board.empty_list[-1] in players[0]._good_set:
                    players[0].win(pos, board)
                    players[1].lose(pos, board)
                elif board.empty_list[-1] in players[0]._bad_set:
                    players[1].win(pos, board)
                    players[0].lose(pos, board)
